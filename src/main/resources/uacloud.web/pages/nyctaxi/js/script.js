...
//刷新变换值
var dataURl1="http://localhost:8080/taxiday/query/AttributeQuery/taxiday01&21B98CAC5B31414B9446D381D38EEC7F"
var dataUrl2="http://localhost:8080/taxiday/query/AttributeQuery/taxiday02&4C4A0AFC432A1A87E97ED8F18403FF6E";
var arr = [dataURl1, dataUrl2];
...
//加载json数据或者url连接
d3.json(arr[localStorage.num], function (data) {
...
if(d.properties.hasfare=="true") { //transition marker to show full taxi
    marker
    .transition()
    .duration(500)
    .attr("r",5)
